package logic.avaliacao.model.list;
...
public class ListAdapterModel<E> extends AbstractListModel<E> {
	...
	/**
	 * Returns the list that this {@link ListAdapterModel} is backed by.
	 *
	 * @return
	 */
